        ...
        <section className="py-14 md:py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-3 text-3xl font-bold text-gray-900 md:text-4xl">
                Một số công trình thực tế tại Nghệ An
              </h2>

              <p className="mt-4 leading-7 text-gray-600">
                Khu vực này nên sử dụng ảnh công trình đang thi công, ảnh hoàn
                thiện và ảnh so sánh với phối cảnh thiết kế.
              </p>
            </div>
        ...
        <section className="border-y border-amber-100 bg-amber-50/60 py-14 md:py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-3 text-3xl font-bold text-gray-900 md:text-4xl">
                Những mẫu nhà được nhiều gia đình lựa chọn
              </h2>
            </div>
                ...
                >
                  <Link href={style.url}>
                    ...
                    <div className="p-5">
                      ...
                      <span className="mt-4 inline-block font-semibold text-amber-700">
                        Xem mẫu nhà →
                      </span>
                    </div>
                  </Link>
        ...
        <section className="border-y border-amber-100 bg-[#fffaf0] py-14 md:py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-3 text-3xl font-bold text-gray-900 md:text-4xl">
                Hình ảnh hồ sơ thiết kế nhà ở
              </h2>

              <p className="mt-4 leading-7 text-gray-600">
                Bạn nên thay các ảnh bên dưới bằng bản vẽ mặt bằng, phối cảnh,
                mặt đứng, kết cấu và điện nước của công ty.
              </p>
            </div>
